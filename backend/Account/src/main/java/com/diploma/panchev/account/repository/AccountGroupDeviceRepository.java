...
public interface AccountGroupDeviceRepository extends JpaRepository<AccountGroupDeviceEntity, UUID>, JpaSpecificationExecutor<AccountGroupDeviceEntity> {
    ...
    Optional<AccountGroupDeviceEntity> findByAccountDeviceAccountIdAndGroupIdAndAccountDeviceDeviceId(UUID accountId, UUID groupId, String deviceId);

    List<AccountGroupDeviceEntity> findByGroupId(UUID groupId);
}
